...
var formElt = document.getElementById('personForm');
formElt.addEventListener('submit', function(e) {
  e.preventDefault();
  console.log('they submitted the form');
  var personCreatedFromForm = new Person(e.target.name.value, e.target.shoeSize.value, e.target.eyes.value, e.target.shirt.value);
  personCreatedFromForm.addInfo();
});
